 ...
 // ---------------------------
    ...
    empfang: {
       ...
       // -----------------
          ...
          if ((~befehl.indexOf("--ANSPRECHPARTNER")) && (botsan == true)) { versuch = true; return bot.say(EmpfangsBot+' Ein Text über Frau '+prop_ansprechpartner+'. ').then(() => 'empfang');}if ((~befehl.indexOf("--BERATER")) && (botsan == true)) { versuch = true; return bot.say(EmpfangsBot+' Ein Text über Frau '+prop_ansprechpartner+'. ').then(() => 'empfang');}          
       // -----------------
       // Material
       // -----------------
