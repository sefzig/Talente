 ...
 // ---------------------------
    ...
    empfang: {
       ...
       // -----------------
          ...
          if ((~befehl.indexOf("--TALENTE")) && (botsan == true)) { versuch = true; return bot.say(EmpfangsBot+' Wir sind eine Personalberatung mit Fokus auf den digitalen Markt und haben es uns zur Aufgabe gemacht, eine langfristige und vertrauensvolle Beziehung zwischen Ihnen und unseren Autraggebern herzustellen. Mehr über uns: [Button:Unsere Webseite,http://www.talente.de] ').then(() => bot.say(EmpfangsBot+' Wir sind auf Facebook aktiv: [Button:Talente auf Facebook,https://www.facebook.com/talente/] Oder ziehen Sie [Textlink:Twitter,https://www.twitter.com/talente/] vor? ')).then(() => bot.say(EmpfangsBot+' Sie finden uns auf LinkedIn: [Button:LinkedIn Unternehmensprofil,http://www.linkedin.com/company/talente]  ')).then(() => bot.say(EmpfangsBot+' Und natürlich auch auf XING: [Button:XING Unternehmensprofil,http://www.xing.com/companies/talente]  ')).then(() => 'empfang');}          
          if (prop_ansprechpartner == "Urbat") {
             
             if ((~befehl.indexOf("--ANSPRECHPARTNER")) && (botsan == true)) { versuch = true; return bot.say(EmpfangsBot+' Ihr Ansprechpartner bei uns ist Frau '+prop_ansprechpartner+'. Sie ist ausgebildete Journalistin und wurde 2002 mit dem Medienpreis “Das silberne Pferd” ausgezeichnet. Als passionierte Jagdreiterin liegt ihr die hartnäckige Verfolgung einer vielversprechenden Spur im Blut, weshalb sie die Herausforderungen liebt, die sich ihr als Headhunterin stellen. ').then(() => bot.say(EmpfangsBot+' Sprechen Sie sie hier im Chat an: --'+prop_ansprechpartner+' - oder möchten Sie auf anderem Wege --Kontakt zu ihr aufnehmen? ')).then(() => 'empfang');}if ((~befehl.indexOf("--BERATER")) && (botsan == true)) { versuch = true; return bot.say(EmpfangsBot+' Ihr Ansprechpartner bei uns ist Frau '+prop_ansprechpartner+'. Sie ist ausgebildete Journalistin und wurde 2002 mit dem Medienpreis “Das silberne Pferd” ausgezeichnet. Als passionierte Jagdreiterin liegt ihr die hartnäckige Verfolgung einer vielversprechenden Spur im Blut, weshalb sie die Herausforderungen liebt, die sich ihr als Headhunterin stellen. ').then(() => bot.say(EmpfangsBot+' Sprechen Sie sie hier im Chat an: --'+prop_ansprechpartner+' - oder möchten Sie auf anderem Wege --Kontakt zu ihr aufnehmen? ')).then(() => 'empfang');}	       
          }
          
          if (prop_ansprechpartner == "Ortwerth") {
             
             if ((~befehl.indexOf("--ANSPRECHPARTNER")) && (botsan == true)) { versuch = true; return bot.say(EmpfangsBot+' Ihr Ansprechpartner bei uns ist Frau '+prop_ansprechpartner+'. Sie ist studierte Wirtschaftswissenschaftlerin mit Schwerpunkt Wirtschaftsinformatik und hat u.a. für die aktuelle Nummer 1 des aktuellen ConsultingStar-Rankings gearbeitet. Als leidenschaftliche Surferin und Wettkampftänzerin steht sie regelmäßig auf dem Brett und auf der Bühne. ').then(() => bot.say(EmpfangsBot+' Sprechen Sie sie hier im Chat an: --'+prop_ansprechpartner+' - oder möchten Sie auf anderem Wege --Kontakt zu ihr aufnehmen? ')).then(() => 'empfang');}if ((~befehl.indexOf("--BERATER")) && (botsan == true)) { versuch = true; return bot.say(EmpfangsBot+' Ihr Ansprechpartner bei uns ist Frau '+prop_ansprechpartner+'. Sie ist studierte Wirtschaftswissenschaftlerin mit Schwerpunkt Wirtschaftsinformatik und hat u.a. für die aktuelle Nummer 1 des aktuellen ConsultingStar-Rankings gearbeitet. Als leidenschaftliche Surferin und Wettkampftänzerin steht sie regelmäßig auf dem Brett und auf der Bühne. ').then(() => bot.say(EmpfangsBot+' Sprechen Sie sie hier im Chat an: --'+prop_ansprechpartner+' - oder möchten Sie auf anderem Wege --Kontakt zu ihr aufnehmen? ')).then(() => 'empfang');}	       
          }
